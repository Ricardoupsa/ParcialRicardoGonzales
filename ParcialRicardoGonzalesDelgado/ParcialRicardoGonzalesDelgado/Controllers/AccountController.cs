...
using ParcialRicardoGonzalesDelgado.Models;
using ParcialRicardoGonzalesDelgado.Providers;
using ParcialRicardoGonzalesDelgado.Results;

namespace ParcialRicardoGonzalesDelgado.Controllers
{
    [Authorize]
